...
Main.prototype = $extend(com.haxepunk.Engine.prototype,{
	init: function() {
		...
		com.haxepunk.HXP.set_scene(Main.sceneGame);
	}
	,__class__: Main
});
...
entities.Obstacle.prototype = $extend(com.haxepunk.Entity.prototype,{
	...
	,update: function() {
		...
		this.moveBy(-(this.velocity + this.velocity * this.vFactor),0);
...
entities.Player.prototype = $extend(com.haxepunk.Entity.prototype,{
	...
	,update: function() {
		...
		if(this.isReady && this.isAlive) {
			...
			if(this.collide("obstacle",this.followCamera?this.x + com.haxepunk.HXP.camera.x:this.x,this.followCamera?this.y + com.haxepunk.HXP.camera.y:this.y) != null) this.destroy();
...
scenes.Game.prototype = $extend(com.haxepunk.Scene.prototype,{
	...
	,log: function(sampleTime) {
		...
		if(this._logTimer >= sampleTime) {
			...
			this._fpsSqrSum += this._fps * this._fps;
			...
			this._fpsVar = com.haxepunk.HXP.round(1 / this._fpsCount * (this._fpsSqrSum - this._fpsSum * this._fpsSum / this._fpsCount),4);
			this._lDebug.set_text("FPS: " + this._fps + " \tMIN: " + this._fpsMin + " \tMAX: " + this._fpsMax + " \tAVG: " + this._fpsAvg + " \tVAR: " + this._fpsVar);
			this._logTimer = 0;
		}
	}
